...
- (void)testSSKeychain {
    ...
    // check password
    XCTAssertEqualObjects([SSKeychain passwordForService:kSSKeychainServiceName account:kSSKeychainAccountName error:nil], kSSKeychainPassword, @"Passwords were not equal");
    
    // check all accounts
    XCTAssertTrue([self _accounts:[SSKeychain allAccounts:nil] containsAccountWithName:kSSKeychainAccountName], @"Matching account was not returned");
    // check account
    XCTAssertTrue([self _accounts:[SSKeychain accountsForService:kSSKeychainServiceName  error:nil] containsAccountWithName:kSSKeychainAccountName ], @"Matching account was not returned");
    ...
    XCTAssertTrue([SSKeychain setPassword:kSSKeychainPassword forService:kSSKeychainServiceName account:kSSKeychainAccountName  error:nil], @"Unable to save item");
    XCTAssertTrue([SSKeychain deletePasswordForService:kSSKeychainServiceName account:kSSKeychainAccountName  error:nil], @"Unable to delete password");
